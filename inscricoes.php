...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputAddress" placeholder="Rio Grande do Norte">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Cidade</label>
    <input type="text" class="form-control" id="inputAddress2" placeholder="Caicó">
  </div>
  <div class="form-row">
    <div class="form-group col-md-3">
