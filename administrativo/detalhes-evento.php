				...
				<div class="form-title">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="col-md-2">
								<form action="">		
									<input onclick="window.location='gerar-cracha.php?id_evento=<?php echo $evento['id_evento']; ?>';" type="button" class="btn btn-primary btn-block" value="Gerar Crachá">
								</form>			
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-2">
								<input onclick="window.location='validar-presenca.php?id_evento=<?php echo $evento['id_evento']; ?>';" type="button" class="btn btn-primary btn-block" value="Validar Presença">			
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-2">	
								<input onclick="window.location='deletar-evento.php?id_evento=<?php echo $evento['id_evento']; ?>';" type="button" class="btn btn-primary btn-block" value="Excluir Evento">
							</div>
						</div>
					</div>
				</div>
